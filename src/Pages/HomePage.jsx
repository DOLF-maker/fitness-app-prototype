    ...
    const loadMarkerLibrary = async () => {
      if (map) {
        ...
        marker.addListener("click", () => {
          window.open(
            "https://www.google.com/maps/place/Blueprint+Martial+Arts+Kuala+Lumpur+City+Centre/@3.1525875,101.7096811,17z/data=!3m1!4b1!4m6!3m5!1s0x31cc372a260d9c0d:0x1dc156933475ef44!8m2!3d3.1525875!4d101.712256!16s%2Fg%2F11w1v726kc?entry=ttu&g_ep=EgoyMDI0MTAxNi4wIKXMDSoASAFQAw%3D%3D",
            "_blank"
          );
        });
      }
